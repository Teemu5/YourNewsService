...
function showGraphQLTransformerMigrationMessage() {
    ...
    printer.blankLine();
    printer.warn('Amplify CLI has made improvements to GraphQL APIs. Improvements include pipeline resolvers support, deny-by-default authorization, and improved search and result aggregations.');
