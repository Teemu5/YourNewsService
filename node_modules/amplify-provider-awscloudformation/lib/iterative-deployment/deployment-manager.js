    ...
    constructor(creds, region, deploymentBucket, spinner, printer = new stack_progress_printer_1.StackProgressPrinter(), options = {}) {
        ...
        this.getTableStatus = async (tableName) => {
            ...
            try {
                ...
                if (((_a = response.Table) === null || _a === void 0 ? void 0 : _a.TableStatus) === 'DELETING') {
                    return false;
                }
                const gsis = (_b = response.Table) === null || _b === void 0 ? void 0 : _b.GlobalSecondaryIndexes;
