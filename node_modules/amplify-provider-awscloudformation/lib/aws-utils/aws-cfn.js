...
class CloudFormation {
    ...
    async updateamplifyMetaFileWithStackOutputs(parentStackName) {
        ...
        const rootStackResources = result.StackResources.filter(resource => !['UpdateRolesWithIDPFunction', 'UpdateRolesWithIDPFunctionOutputs', 'UpdateRolesWithIDPFunctionRole'].includes(resource.LogicalResourceId));
