...
class GraphQLResourceManager {
    constructor(props) {
        ...
        this.tableRecreationManagement = (currentState, nextState) => {
            this.getTablesBeingReplaced().forEach(tableMeta => {
                ...
                this.templateState.add(tableMeta.stackName, amplify_cli_core_1.JSONUtilities.stringify(this.getStack(tableMeta.stackName, nextState)));
            });
        };
        this.getTablesBeingReplaced = () => {
            ...
            const getTablesRequiringReplacement = () => {
                ...
                return lodash_1.default.uniq(diffs
                    .filter(diff => (diff.kind === 'E' && diff.path.length === 8 && diff.path[5] === 'KeySchema') || diff.path.includes('LocalSecondaryIndexes'))
                    .map(diff => {
                    var _a;
                    return ({
                        tableName: (_a = diff.path) === null || _a === void 0 ? void 0 : _a[3],
        ...
        this.getTableNameFromTemplate = (template) => { var _a; return (_a = Object.entries((template === null || template === void 0 ? void 0 : template.Resources) || {}).find(([_, resource]) => resource.Type === 'AWS::DynamoDB::Table')) === null || _a === void 0 ? void 0 : _a[0]; };
