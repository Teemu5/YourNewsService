...
exports.getDirectiveDefinitions = exports.transformGraphQLSchema = exports.searchablePushChecks = void 0;
...
function searchablePushChecks(context, map) {
    var _a, _b;
    ...
    if (searchableModelTypes.length) {
        ...
        const apiCategory = (_b = (_a = teamProviderInfo[currEnv]) === null || _a === void 0 ? void 0 : _a.categories) === null || _b === void 0 ? void 0 : _b.api;
        const instanceType = apiCategory ? apiCategory[graphql_transformer_common_1.ResourceConstants.PARAMETERS.ElasticsearchInstanceType] : null;
        if (!instanceType || instanceType === 't2.small.elasticsearch') {
            amplify_prompts_1.printer.warn('Your instance type for OpenSearch is t2.small, you may experience performance issues or data loss. Consider reconfiguring with the instructions here https://docs.amplify.aws/cli/graphql-transformer/searchable/');
        }
    }
}
