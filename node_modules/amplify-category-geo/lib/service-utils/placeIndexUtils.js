...
const createPlaceIndexResource = async (context, parameters) => {
    ...
    const templateMappings = await provider_controllers_1.getTemplateMappings(context);
    const placeIndexStack = new placeIndexStack_1.PlaceIndexStack(new core_1.App(), 'PlaceIndexStack', { ...parameters, ...templateMappings });
