...
const addMapResource = async (context) => {
    ...
    return await exports.addMapResourceWithParams(context, mapParams);
};
...
const updateMapResource = async (context) => {
    ...
    return await exports.updateMapResourceWithParams(context, mapParams);
};
...
const addMapResourceHeadless = async (context, config) => {
    let mapParams = {
        ...
        ...mapParams_2.getMapStyleComponents(config.mapStyle)
    };
    return await exports.addMapResourceWithParams(context, mapParams);
};
