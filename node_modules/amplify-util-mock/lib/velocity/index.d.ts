...
import { AppSyncVTLRenderContext, AppSyncGraphQLExecutionContext, JWTToken, IAMToken } from 'amplify-appsync-simulator';
declare type iamCognitoIdentityContext = Partial<Pick<IAMToken, 'cognitoIdentityPoolId' | 'cognitoIdentityAuthProvider' | 'cognitoIdentityAuthType' | 'cognitoIdentityId'>>;
export interface VelocityTemplateSimulatorOptions {
    authConfig: AppSyncAuthConfiguration;
}
export declare type AppSyncVTLContext = Partial<AppSyncVTLRenderContext>;
export declare type AppSyncVTLPayload = {
