...
export declare type ProcessedLambdaEventSource = CloudFormationProcessedResourceResult & {
    batchSize: number;
    eventSourceArn: string;
    functionName: string;
    startingPosition: string;
};
export declare type ProcessedOpenSearchDomain = CloudFormationProcessedResourceResult & {
    endpoint: string;
};
