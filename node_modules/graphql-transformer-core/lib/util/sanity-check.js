...
const cantRemoveTableAfterCreation = (_, currentBuild, nextBuild) => {
    const getNestedStackLogicalIds = (proj) => Object.entries(proj.root.Resources || [])
    ...
    if (removedModels.length > 0) {
        throw new errors_1.DestructiveMigrationError('Removing a model from the GraphQL schema will also remove the underlying DynamoDB table.', removedModels, []);
    }
};
