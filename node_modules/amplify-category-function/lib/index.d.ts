...
export declare function lambdaLayerPrompt(context: $TSContext, resources: Array<$TSAny>): Promise<void>;
export declare function postPushCleanup(resource: Array<$TSAny>, envName: string): Promise<void>;
