...
const getFunctionCloudFormationTemplate = async (functionName) => {
    const { cfnTemplate } = amplify_cli_core_1.readCFNTemplate(functionCloudFormationFilePath(functionName));
    return cfnTemplate;
};
exports.getFunctionCloudFormationTemplate = getFunctionCloudFormationTemplate;
const setFunctionCloudFormationTemplate = async (functionName, cfnTemplate) => amplify_cli_core_1.writeCFNTemplate(cfnTemplate, functionCloudFormationFilePath(functionName));
