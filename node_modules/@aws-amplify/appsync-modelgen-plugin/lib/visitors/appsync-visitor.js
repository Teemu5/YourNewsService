...
class AppSyncModelVisitor extends visitor_plugin_common_1.BaseVisitor {
    ...
    generateIntermediateModel(firstModel, secondModel, firstField, secondField, relationName) {
        const firstModelKeyFieldName = `${change_case_1.camelCase(firstModel.name)}ID`;
        const secondModelKeyFieldName = `${change_case_1.camelCase(secondModel.name)}ID`;
        let intermediateModel = {
            ...
            fields: [
                ...
                },
                {
                    ...
                    isNullable: false,
                    isList: false,
                    name: change_case_1.camelCase(firstModel.name),
                ...
                },
                {
                    ...
                    isNullable: false,
                    isList: false,
                    name: change_case_1.camelCase(secondModel.name),
