...
async function addCloudFormationWalkthrough(context) {
    const resourceName = await common_questions_1.customResourceNameQuestion();
    await generateSkeletonDir(context, resourceName);
    await updateAmplifyMetaFiles(context, resourceName);
    await dependency_management_utils_1.addCFNResourceDependency(context, resourceName);
