...
exports.transformCategoryStack = exports.handleAmplifyEvent = exports.executeAmplifyCommand = exports.generateDependentResourcesType = exports.addCDKResourceDependency = void 0;
...
async function transformCategoryStack(context, resource) {
    await build_custom_resources_1.buildCustomResources(context, resource.resourceName);
}
