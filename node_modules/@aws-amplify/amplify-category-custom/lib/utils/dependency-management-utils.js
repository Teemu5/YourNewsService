...
async function addCFNResourceDependency(context, customResourceName) {
    ...
    const customResourceCFNTemplate = amplify_cli_core_1.readCFNTemplate(customResourceCFNFilepath);
    ...
    await amplify_cli_core_1.writeCFNTemplate(customResourceCFNTemplate.cfnTemplate, customResourceCFNFilepath, {
