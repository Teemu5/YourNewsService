...
function makeQueryResolver(config, ctx) {
    ...
    resolver.addToSlot('postAuth', graphql_transformer_core_1.MappingTemplate.s3MappingTemplateFromString(exports.generateAuthExpressionForSandboxMode(ctx.sandboxModeEnabled), `${queryTypeName}.${queryField}.{slotName}.{slotIndex}.res.vtl`));
