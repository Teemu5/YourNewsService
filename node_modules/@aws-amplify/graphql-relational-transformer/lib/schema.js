...
exports.getPartitionKeyField = exports.ensureHasManyConnectionField = exports.ensureBelongsToConnectionField = exports.ensureHasOneConnectionField = exports.extendTypeWithConnection = void 0;
...
function ensureHasOneConnectionField(config, ctx, connectionAttributeName) {
...
function ensureBelongsToConnectionField(config, ctx) {
...
function updateTypeWithConnectionField(object, connectionFieldName, nonNull = false) {
...
function updateFilterConnectionInputWithConnectionField(input, connectionFieldName) {
    const keyFieldExists = input.fields.some(f => f.name.value === connectionFieldName);
    if (keyFieldExists) {
        return input;
    }
