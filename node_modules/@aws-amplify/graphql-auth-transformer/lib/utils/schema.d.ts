...
export declare const getModelConfig: (directive: DirectiveNode, typeName: string, isDataStoreEnabled?: boolean) => ModelDirectiveConfiguration;
export declare const getSearchableConfig: (directive: DirectiveNode, typeName: string) => SearchableConfig | null;
...
export declare const getTable: (ctx: TransformerContextProvider, def: ObjectTypeDefinitionNode) => any;
