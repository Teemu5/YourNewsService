...
declare type AmplifyS3Conditions = Record<string, cdk.CfnCondition>;
declare type AmplifyS3CfnParameters = Record<string, cdk.CfnParameter>;
export {};
