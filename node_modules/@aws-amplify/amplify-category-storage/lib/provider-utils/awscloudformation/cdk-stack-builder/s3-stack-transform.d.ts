...
import { AmplifyBuildParamsPermissions, AmplifyCfnParamType } from './types';
export declare function transformS3ResourceStack(context: $TSContext, resource: IAmplifyResource): Promise<void>;
export declare class AmplifyS3ResourceStackTransform {
    ...
    _getPublicPrivatePermissions(authPermissions: Array<S3PermissionType> | undefined, excludeListBuckets: boolean): string;
    _getUploadPermissions(authPermissions: Array<S3PermissionType> | undefined): string;
