...
export declare function askBucketNameQuestion(context: $TSContext, defaultValues: S3UserInputs, resourceName: string): Promise<string>;
...
export declare function askUserPoolGroupSelectionUntilPermissionSelected(userPoolGroupList: string[], context: $TSContext, userInput: S3UserInputs): Promise<string>;
