...
export declare type S3CFNDependsOn = {
    category: string;
    resourceName: string;
    attributes: string[];
};
export declare type GroupCFNAccessType = Record<string, S3CFNPermissionType[]>;
export declare type GroupStorageParamsAccessType = Record<string, S3StorageParamsPermissionType[]>;
export declare type S3FeatureMetadata = {
    dependsOn: S3CFNDependsOn[];
};
export declare type S3InputStateOptions = {
    resourceName: string;
    inputPayload?: S3UserInputs;
    metadata?: S3FeatureMetadata;
};
export declare function canResourceBeTransformed(resourceName: string): boolean;
export declare class S3InputState {
    ...
    updateInputPayload(props: S3InputStateOptions): void;
    static getInstance(props: S3InputStateOptions): S3InputState;
