...
async function askResourceNameQuestion(context, defaultValues) {
    ...
    const resourceName = await amplify_prompts_1.prompter.input(message, { validate: amplify_prompts_1.alphanumeric(onErrorMsg), initial: defaultResourceName });
    return resourceName;
}
exports.askResourceNameQuestion = askResourceNameQuestion;
async function askBucketNameQuestion(context, defaultValues, resourceName) {
    ...
    const validator = amplify_prompts_1.and([amplify_prompts_1.alphanumeric(), amplify_prompts_1.minLength(3), amplify_prompts_1.maxLength(47)], onErrorMsg);
...
async function askCRUDQuestion(role, groupName = undefined, context, defaultValues) {
    const roleDefaultValues = s3_user_input_types_1.getRoleAccessDefaultValues(role, groupName, defaultValues);
...
async function askUserPoolGroupSelectionUntilPermissionSelected(userPoolGroupList, context, userInput) {
