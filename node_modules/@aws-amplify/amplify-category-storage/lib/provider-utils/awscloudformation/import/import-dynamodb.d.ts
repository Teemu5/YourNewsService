...
export declare const importDynamoDB: (context: $TSContext, serviceSelection: ServiceSelection, previousResourceParameters: DynamoDBResourceParameters | undefined, providerPluginInstance?: ProviderUtils | undefined, printSuccessMessage?: boolean) => Promise<{
