...
export declare const importS3: (context: $TSContext, serviceSelection: ServiceSelection, previousResourceParameters: S3ResourceParameters | undefined, providerPluginInstance?: ProviderUtils | undefined, printSuccessMessage?: boolean) => Promise<{
