...
class GraphQLTransform {
    constructor(options) {
        ...
        validation_1.validateAuthModes(this.authConfig);
    ...
    transform(schema) {
        ...
        const context = new transformer_context_1.TransformerContext(this.app, parsedDocument, this.stackMappingOverrides, this.authConfig, this.options.sandboxModeEnabled, this.options.featureFlags, this.transformConfig.ResolverConfig);
