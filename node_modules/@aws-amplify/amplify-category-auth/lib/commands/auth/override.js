...
const run = async (context) => {
    ...
    if (selectedAuthResource === 'userPoolGroups') {
        authResourceName = await getAuthResourceName_1.getAuthResourceName(context);
        await check_for_auth_migration_1.checkAuthResourceMigration(context, authResourceName, false);
    }
    else {
        await check_for_auth_migration_1.checkAuthResourceMigration(context, selectedAuthResource, false);
    }
    if (selectedAuthResource === 'userPoolGroups') {
