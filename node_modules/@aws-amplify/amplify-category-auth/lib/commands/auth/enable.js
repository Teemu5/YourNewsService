...
const run = async (context) => {
    ...
    const serviceSelectionPromptResult = await amplify.serviceSelectionPrompt(context, exports.category, supported_services_1.getSupportedServices());
    const providerController = await Promise.resolve().then(() => __importStar(require(path.join(`..`, `..`, `provider-utils`, `${serviceSelectionPromptResult.providerName}`, `index`))));
