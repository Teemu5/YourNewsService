...
exports.updateUserPoolGroups = exports.createUserPoolGroups = exports.removeDeprecatedProps = exports.saveResourceParameters = exports.copyCfnTemplate = exports.getResourceUpdater = exports.getResourceSynthesizer = void 0;
...
const createUserPoolGroups = async (context, resourceName, userPoolGroupList) => {
    if (userPoolGroupList && userPoolGroupList.length > 0) {
        ...
        const userPoolGroupParams = path.join(amplify_cli_core_1.pathManager.getBackendDirPath(), 'auth', 'userPoolGroups', 'build', 'parameters.json');
        const groupParams = {
            AuthRoleArn: {
        ...
        await generate_user_pool_group_stack_template_1.generateUserPoolGroupStackTemplate(context, resourceName);
    }
};
