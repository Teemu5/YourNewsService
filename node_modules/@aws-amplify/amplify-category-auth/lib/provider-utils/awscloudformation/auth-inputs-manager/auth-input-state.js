...
class AuthInputState extends amplify_cli_core_1.CategoryInputState {
    ...
    async isCLIInputsValid(cliInputs = this.getCLIInputPayload()) {
        const schemaValidator = new amplify_cli_core_1.CLIInputSchemaValidator('awsCognito', __classPrivateFieldGet(this, _AuthInputState_category, "f"), 'CognitoCLIInputs');
