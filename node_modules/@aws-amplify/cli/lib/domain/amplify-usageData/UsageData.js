...
class UsageData {
    ...
    async emit(error, state) {
        const payload = new UsageDataPayload_1.UsageDataPayload(this.sessionUuid, this.installationUuid, this.version, this.input, error, state, this.accountId, this.projectSettings, this.inputOptions, this.record);
