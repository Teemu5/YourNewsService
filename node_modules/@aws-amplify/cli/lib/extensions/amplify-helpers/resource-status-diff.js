...
class ResourceDiff {
    constructor(category, resourceName, provider, mutationInfo) {
        ...
        this.calculateCfnDiff = async () => {
            ...
            this.localTemplate = amplify_cli_core_1.generateCustomPoliciesInTemplate(this.localTemplate, this.resourceName, this.service, this.category);
        ...
        this.safeReadCFNTemplate = async (filePath) => {
            const templateResult = amplify_cli_core_1.readCFNTemplate(filePath, { throwIfNotExist: false });
