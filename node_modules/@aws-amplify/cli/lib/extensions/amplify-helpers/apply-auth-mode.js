...
async function handleValidGraphQLAuthError(context, message) {
    ...
    else if (!((_b = (_a = context === null || context === void 0 ? void 0 : context.parameters) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.yes)) {
...
function checkIfAuthExists() {
    const amplifyMeta = get_project_meta_1.getProjectMeta();
