...
exports.raiseEvent = exports.raisePostEnvAddEvent = exports.raiseIntenralOnlyPostEnvRemoveEvent = exports.isContainersEnabled = exports.executeCommand = void 0;
...
async function selectPluginForExecution(context, pluginCandidates) {
    const pluginCandidatesCategorySet = new Set();
    ...
    if (pluginCandidatesCategorySet.size == 1 && amplify_cli_core_1.overriddenCategories.includes(pluginName)) {
        if (amplify_cli_core_1.FeatureFlags.getBoolean(`overrides.${pluginName}`)) {
...
async function raisePostEnvAddEvent(context, prevEnvName, newEnvName) {
    await raiseEvent(context, new amplify_event_1.AmplifyEventArgs(amplify_event_1.AmplifyEvent.PostEnvAdd, new amplify_event_1.AmplifyPostEnvAddEventData(prevEnvName, newEnvName)));
}
