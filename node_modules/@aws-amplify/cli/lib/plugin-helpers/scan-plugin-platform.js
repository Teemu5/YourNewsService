...
async function scanPluginPlatform(pluginPlatform) {
    ...
    if (pluginPlatform.userAddedLocations && pluginPlatform.userAddedLocations.length > 0) {
        ...
        await promise_sequential_1.default(scanUserLocationTasks);
    }
    ...
    if (pluginPlatform.pluginDirectories.length > 0 && pluginPlatform.pluginPrefixes.length > 0) {
        ...
        await promise_sequential_1.default(scanDirTasks);
    }
...
const addPluginPrefixWithMatchingPattern = async (subDirNames, directory, pluginPlatform) => {
    if (subDirNames.length > 0) {
        ...
        await promise_sequential_1.default(scanSubDirTasks);
    }
};
