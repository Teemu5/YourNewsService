...
async function getTableParameters(dynamoAnswers) {
    var _a;
    ...
    const parametersJson = amplify_cli_core_1.stateManager.getResourceParametersJson(undefined, amplify_cli_core_1.AmplifyCategories.STORAGE, dynamoAnswers.resourceName, { throwIfNotExist: false });
    const buildParamsJson = amplify_cli_core_1.JSONUtilities.readJson(path_1.default.join(amplify_cli_core_1.pathManager.getResourceDirectoryPath(undefined, amplify_cli_core_1.AmplifyCategories.STORAGE, dynamoAnswers.resourceName), 'build', 'parameters.json'), { throwIfNotExist: false });
    return (_a = parametersJson !== null && parametersJson !== void 0 ? parametersJson : buildParamsJson) !== null && _a !== void 0 ? _a : {};
}
