    ...
    return {
        contribute: request => {
            switch (request.selection) {
                ...
                case 'lambda-auth': {
                    return lambdaAuthProvider_1.provideLambdaAuth();
                }
                default: {
