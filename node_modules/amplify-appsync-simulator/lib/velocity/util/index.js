...
function create(errors, now, info, context) {
    ...
    return __assign(__assign(__assign({}, auth_utils_1.authUtils(context)), general_utils_1.generalUtils), { dynamodb: dynamodb_utils_1.dynamodbUtils, list: list_utils_1.listUtils, map: map_utils_1.mapUtils, transform: transform_1.transformUtils, now: now, errors: errors, info: info, time: time_1.time(), str: str_1.str, math: math_1.math, rds: rds_1.rds });
}
