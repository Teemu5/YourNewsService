...
var VelocityTemplate = /** @class */ (function () {
        ...
        try {
            ...
            if (lastError && lastError instanceof util_1.ValidateError) {
                return {
                    ...
                    errors: __spreadArray([], context.util.errors),
                    isReturn: true,
    ...
    VelocityTemplate.prototype.buildRenderContext = function (ctxValues, requestContext, info) {
        ...
        var util = util_1.create([], new Date(Date.now()), info, requestContext);
        ...
        if (requestContext.requestAuthorizationMode === type_definition_1.AmplifyAppSyncSimulatorAuthenticationType.OPENID_CONNECT) {
            ...
            identity = mapper_1.map(__assign({ sub: sub, issuer: issuer, sourceIp: sourceIp, 'cognito:username': cognitoUserName, username: username || cognitoUserName, claims: requestContext.jwt }, (this.simulatorContext.appSyncConfig.defaultAuthenticationType.authenticationType ===
