...
function installDependencies(resourceDir, buildType) {
    runPackageManager(resourceDir, buildType);
}
function runPackageManager(cwd, buildType, scriptName) {
    var _a;
    const packageManager = amplify_cli_core_1.getPackageManager(cwd);
...
function toPackageManagerArgs(useYarn, buildType, scriptName) {
    if (scriptName) {
...
function isBuildStale(resourceDir, lastBuildTimeStamp, buildType, lastBuildType) {
