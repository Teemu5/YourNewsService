      ...
      `);
        ...
        this.field = (parent, field, directive, ctx) => {
            ...
            if (leftConnectionIsList && rightConnectionIsList) {
                ...
                if (createInput) {
                    const updated = definitions_1.updateInputWithConnectionField(createInput, connectionAttributeName, leftConnectionIsNonNull);
                    ctx.putType(updated);
                }
                ...
                if (updateInput) {
                    const updated = definitions_1.updateInputWithConnectionField(updateInput, connectionAttributeName);
                    ctx.putType(updated);
                }
            }
                ...
                const createInput = ctx.getType(createInputName);
                if (createInput) {
                    const updated = definitions_1.updateInputWithConnectionField(createInput, connectionAttributeName);
                    ctx.putType(updated);
                }
